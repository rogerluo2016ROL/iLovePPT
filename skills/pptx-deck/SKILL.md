...
### 路 B：brief.yaml
用户直接给 yaml。schema 见 [brief.example.yaml](brief.example.yaml),demo 见 [examples/demo_plan.json](examples/demo_plan.json)。

## 主流程 7 步

详见 [workflow.md](workflow.md)。构建步骤（mechanical builder）：
