...
flowchart TB
    ...
    CR -->|pass| BD["<b>4 · builder</b><br/>build.py + 17 项机械视觉 QA"]
    BD --> DS["<b>5 · designer</b><br/>iconify / Unsplash / brand 加视觉"]
    DS --> AD{{"<b>6 · audience</b><br/>9 分硬阈值"}}
