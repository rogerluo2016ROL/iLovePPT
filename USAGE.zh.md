...
- agent 层设计（主入口）：`docs/superpowers/specs/2026-05-23-iloveppt-agent-design.md`
- agent 层实施计划：`docs/superpowers/plans/2026-05-23-iloveppt-agent.md`
- v2 架构基底设计：`docs/superpowers/specs/2026-05-22-iloveppt-v2-design.md`
- v2 实施计划：`docs/superpowers/plans/2026-05-22-iloveppt-v2.md`
