# iLovePPT Skill 库实现计划

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** 构建三层 PPT 生成 skill 库（`pptx-deck` 端到端 / `pptx` 底层读写 / `diagram` 独立图层）,在 `/Users/pc2026/Documents/DevTools/iLovePPT/skills/` 下落地,能从 brief.yaml 跑出 .pptx 成品并通过逐页视觉自检。
...
**Spec source of truth:** `docs/superpowers/specs/2026-05-21-iloveppt-skill-design.md`。Plan 在叙述上不重复 spec 内容,只给文件路径、关键代码骨架、验证命令。
...
**Files:**
- Create: `/Users/pc2026/Documents/DevTools/iLovePPT/.gitignore`
- Create: `/Users/pc2026/Documents/DevTools/iLovePPT/README.md`
- Create: `/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/themes/__init__.py`（空文件）
- Create: `/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/examples/.gitkeep`
- Create: `/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx/examples/.gitkeep`
- Create: `/Users/pc2026/Documents/DevTools/iLovePPT/skills/diagram/examples/.gitkeep`
...
详见 `docs/superpowers/specs/2026-05-21-iloveppt-skill-design.md`。
```

- [ ] **Step 3: 创建空目录占位**

```bash
mkdir -p /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/themes
mkdir -p /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/examples
mkdir -p /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx/examples
mkdir -p /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx/scripts/office
mkdir -p /Users/pc2026/Documents/DevTools/iLovePPT/skills/diagram/examples
touch /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/themes/__init__.py
touch /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/examples/.gitkeep
touch /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx/examples/.gitkeep
touch /Users/pc2026/Documents/DevTools/iLovePPT/skills/diagram/examples/.gitkeep
```
...
git commit -m "chore: bootstrap iLovePPT skill repo"
```
...
**Files:**
- Copy: 源 `/Users/pc2026/Documents/DevAgents/AppGenesisForge/.claude/skills/pptx/scripts/` 全部内容到 `/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx/scripts/`
...
DST=/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx/scripts
...
```bash
chmod +x /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx/scripts/check_deps.sh
bash /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx/scripts/check_deps.sh
```
...
期望：输出 `✅ saved: /tmp/iloveppt_minimal.pptx`。

- [ ] **Step 3: 渲染验证（视觉 smoke test）**

```bash
cd /tmp && rm -rf iloveppt_preview && mkdir iloveppt_preview && cd iloveppt_preview
soffice --headless --convert-to pdf /tmp/iloveppt_minimal.pptx
pdftoppm -jpeg -r 120 iloveppt_minimal.pdf slide
ls slide-*.jpg
```
...
<mxfile host="app.diagrams.net" version="30.0.1">
  <diagram name="iloveppt-minimal" id="D1">
...
```bash
chmod +x /Users/pc2026/Documents/DevTools/iLovePPT/skills/diagram/examples/render.sh
bash /Users/pc2026/Documents/DevTools/iLovePPT/skills/diagram/examples/render.sh
```

期望：输出 `✅ 渲染产物：.../minimal.png`,且 minimal.png 文件存在、≥ 50KB（避免 800px 默认糊图）。

```bash
ls -lh /Users/pc2026/Documents/DevTools/iLovePPT/skills/diagram/examples/minimal.png
```
...
import sys
sys.path.insert(0, "/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx")
sys.path.insert(0, "/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck")
from pptx import Presentation
from pptx.util import Inches
from themes import tech_blue as T
...
T.make_cover(prs, "iLovePPT 主题演示", "tech_blue 11 layout")
...
subprocess.run(["soffice", "--headless", "--convert-to", "pdf",
                "/tmp/iloveppt_minimal.pptx", "--outdir", "/tmp/"], check=True)
subprocess.run(["pdftoppm", "-jpeg", "-r", "100",
                "/tmp/iloveppt_minimal.pdf", "/tmp/p"], check=True)
...
T.make_summary(prs, ["结论 1：自动化 PPT 可行", "结论 2：视觉自检有效",
                     "结论 3：成本下降 80%"])
T.make_closing(prs, "Contact: hello@iloveppt.dev")
...
```yaml
# iLovePPT pptx-deck brief schema 完整样例
...
key_points:
  ...
  - "支持模板学风格"
theme: tech_blue
output: /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/examples/sample_output.pptx
...
```bash
python3 -c "import yaml; yaml.safe_load(open('/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/brief.example.yaml'))"
python3 -c "import yaml; yaml.safe_load(open('/Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/examples/demo_brief.yaml'))"
```
...
2. 用 Read 看 /tmp/iloveppt_render/page_NN.png
...
```bash
cd /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck
python3 workflow.py examples/demo_brief.yaml
```
...
```bash
soffice --headless --convert-to pdf /Users/pc2026/Documents/DevTools/iLovePPT/skills/pptx-deck/examples/sample_output.pptx --outdir /tmp/
pdftoppm -jpeg -r 100 /tmp/sample_output.pdf /tmp/so
ls /tmp/so-*.jpg
```

期望：~12 张 jpg。逐张 Read 抽 4 张关键页：
- so-01.jpg 封面：深蓝 + "iLovePPT 自动化 PPT 生成"
- so-02.jpg 目录：4 个章节
...
**Files:**
- Modify: `/Users/pc2026/Documents/DevTools/iLovePPT/README.md`
...
\`\`\`bash
ln -s /path/to/iLovePPT/skills/* /path/to/your-project/.claude/skills/
\`\`\`
...
完整设计见 [docs/superpowers/specs/2026-05-21-iloveppt-skill-design.md](docs/superpowers/specs/2026-05-21-iloveppt-skill-design.md)。
...
cd /Users/pc2026/Documents/DevTools/iLovePPT
git add README.md
git commit -m "docs: write iLovePPT README"
```
